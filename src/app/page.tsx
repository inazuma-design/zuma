    ...
    <>
      ...
      <section className="mx-auto max-w-5xl px-4 py-14">
        <div className="grid gap-4 sm:grid-cols-3">
          {[
            ["💳", "月額課金・無料体験", "複数の料金プランと無料体験期間を自由に設定。毎月自動で継続課金。"],
            ["🔒", "限定コンテンツ・動画", "記事や動画をプラン単位で公開範囲を指定して配信。"],
            ["💬", "トークルーム", "テーマ別のトークルームで、ファン同士・クリエイターと交流。"],
            ["🎥", "イベント・ライブ配信", "オンライン配信やファンミーティングの参加受付・定員管理。"],
            ["🛍️", "グッズ販売（EC）", "会員限定グッズの販売から注文・発送管理までひとつで。"],
            ["🏆", "ポイント・会員証", "応援ポイントとランキング、デジタル会員証でファンの熱量を可視化。"],
          ].map(([icon, title, text]) => (
